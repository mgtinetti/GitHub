...
export const RANKINGS_2025: Record<string, RankingEntry[]> = {
  "user-tinetti": [
    ...
    makeRanking("user-tinetti", 2025, "season-bear-4", 2, 9.2, "High"),
    makeRanking("user-tinetti", 2025, "season-andor-2", 3, 9.0, "High"),
    makeRanking("user-tinetti", 2025, "season-whitelotus-3", 4, 8.8, "Medium"),
    makeRanking("user-tinetti", 2025, "season-succession-4", 5, 9.8, "Instant Classic"),
    makeRanking("user-tinetti", 2025, "season-shogun-1", 6, 9.0, "High"),
    makeRanking("user-tinetti", 2025, "season-fallout-1", 7, 8.5, "Medium"),
    makeRanking("user-tinetti", 2025, "season-hacks-3", 8, 8.3, "Medium"),
    makeRanking("user-tinetti", 2025, "season-adolescence-1", 9, 8.7, "High"),
    makeRanking("user-tinetti", 2025, "season-slowhorses-4", 10, 8.2, "Medium"),
    makeRanking("user-tinetti", 2025, "season-thestudio-1", 11, 8.0, "Low"),
    makeRanking("user-tinetti", 2025, "season-daredevil-1", 12, 7.8, "Low"),
    makeRanking("user-tinetti", 2025, "season-reacher-3", 13, 7.5, "Low"),
    makeRanking("user-tinetti", 2025, "season-barry-4", 14, 8.9, "Medium"),
    makeRanking("user-tinetti", 2025, "season-shrinking-2", 15, 8.0, "Medium"),
  ],
  "user-chubbs": [
    makeRanking("user-chubbs", 2025, "season-succession-4", 1, 9.9, "Instant Classic"),
    makeRanking("user-chubbs", 2025, "season-severance-2", 2, 9.3, "High"),
    makeRanking("user-chubbs", 2025, "season-bear-4", 3, 9.0, "High"),
    makeRanking("user-chubbs", 2025, "season-barry-4", 4, 8.9, "Medium"),
    makeRanking("user-chubbs", 2025, "season-whitelotus-3", 5, 8.5, "Low"),
    makeRanking("user-chubbs", 2025, "season-shogun-1", 6, 8.8, "High"),
    makeRanking("user-chubbs", 2025, "season-andor-2", 7, 8.4, "Medium"),
    makeRanking("user-chubbs", 2025, "season-hacks-3", 8, 8.6, "High"),
    makeRanking("user-chubbs", 2025, "season-fallout-1", 9, 8.2, "Medium"),
    makeRanking("user-chubbs", 2025, "season-slowhorses-4", 10, 8.0, "Medium"),
    makeRanking("user-chubbs", 2025, "season-daredevil-1", 11, 7.9, "Low"),
    makeRanking("user-chubbs", 2025, "season-shrinking-2", 12, 7.8, "Medium"),
    makeRanking("user-chubbs", 2025, "season-adolescence-1", 13, 8.0, "Medium"),
    makeRanking("user-chubbs", 2025, "season-reacher-3", 14, 7.5, "Low"),
    makeRanking("user-chubbs", 2025, "season-thestudio-1", 15, 7.3, "Low"),
  ],
  "user-poteete": [
    makeRanking("user-poteete", 2025, "season-severance-2", 1, 9.4, "High"),
    makeRanking("user-poteete", 2025, "season-andor-2", 2, 9.3, "High"),
    makeRanking("user-poteete", 2025, "season-bear-4", 3, 9.1, "Medium"),
    makeRanking("user-poteete", 2025, "season-succession-4", 4, 8.9, "High"),
    makeRanking("user-poteete", 2025, "season-shrinking-2", 5, 8.7, "Medium"),
    makeRanking("user-poteete", 2025, "season-shogun-1", 6, 8.9, "High"),
    makeRanking("user-poteete", 2025, "season-adolescence-1", 7, 8.8, "High"),
    makeRanking("user-poteete", 2025, "season-whitelotus-3", 8, 8.3, "Low"),
    makeRanking("user-poteete", 2025, "season-fallout-1", 9, 8.5, "High"),
    makeRanking("user-poteete", 2025, "season-hacks-3", 10, 8.1, "Medium"),
    makeRanking("user-poteete", 2025, "season-thestudio-1", 11, 8.4, "Medium"),
    makeRanking("user-poteete", 2025, "season-barry-4", 12, 8.0, "Low"),
    makeRanking("user-poteete", 2025, "season-daredevil-1", 13, 7.9, "Low"),
    makeRanking("user-poteete", 2025, "season-reacher-3", 14, 7.6, "Low"),
    makeRanking("user-poteete", 2025, "season-slowhorses-4", 15, 7.8, "Medium"),
  ],
};
